...
file_path <- "C:\\Users\\msi\\Desktop\\Projektowanie systemów informatycznych\\teksty\\Trump2025.txt"
...
# Wczytaj słowniki z plików csv ----
afinn <- read.csv("C:\\Users\\msi\\Desktop\\Projektowanie systemów informatycznych\\Słowniki\\afinn (1).csv", stringsAsFactors = FALSE)
bing <- read.csv("C:\\Users\\msi\\Desktop\\Projektowanie systemów informatycznych\\Słowniki\\bing (2).csv", stringsAsFactors = FALSE)
loughran <- read.csv("C:\\Users\\msi\\Desktop\\Projektowanie systemów informatycznych\\Słowniki\\loughran (1).csv", stringsAsFactors = FALSE)
nrc <- read.csv("C:\\Users\\msi\\Desktop\\Projektowanie systemów informatycznych\\Słowniki\\nrc (1).csv", stringsAsFactors = FALSE)

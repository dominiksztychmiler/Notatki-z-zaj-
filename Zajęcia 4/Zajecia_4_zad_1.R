...
afinn <- read.csv("C:\\Users\\msi\\Downloads\\afinn.csv", stringsAsFactors = FALSE)
bing <- read.csv("C:\\Users\\msi\\Downloads\\bing.csv", stringsAsFactors = FALSE)
loughran <- read.csv("C:\\Users\\msi\\Downloads\\loughran.csv", stringsAsFactors = FALSE)
nrc <- read.csv("C:\\Users\\msi\\Downloads\\nrc.csv", stringsAsFactors = FALSE)
...
# Analiza sentymentu 2 ----



# Analiza sentymentu przy użyciu słownika Loughran 2 ----
...
# Analiza sentymentu przy użyciu słownika NRC 2 ----
...
# Analiza sentymentu przy użyciu słownika Bing 2 ----
...
# Analiza sentymentu przy użyciu słownika Afinn 2 ----

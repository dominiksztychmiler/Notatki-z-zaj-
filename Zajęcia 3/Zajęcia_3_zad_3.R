...
file_paths <- c("C:/Users/msi/Desktop/Biden2021.txt", "C:/Users/msi/Desktop/Biden2024.txt")
...
for (file_path in file_paths) {
  ...
  plot_wordcloud(freq_df, paste("Chmura słów -", basename(file_path)), "Dark2")
  
  # Wyświetlenie 10 najczęściej występujących słów
  cat("Najczęściej występujące słowa w pliku", basename(file_path), ":\n")
...
# Przetwarzanie każdego pliku osobno po usunięciu dodatkowych stop słów
for (file_path in file_paths) {
  # Wczytanie i przetworzenie tekstu
  words <- process_text(file_path)
